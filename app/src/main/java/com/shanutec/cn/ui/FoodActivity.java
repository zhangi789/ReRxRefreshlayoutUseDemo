...
import com.shanutec.cn.adapter.FoodAdapter;
import com.shanutec.cn.bean.Food;
import com.xfresh.cn.RxRefreshLayout;
import com.xfresh.cn.header.bezierlayout.BezierLayout;
...
//        refreshLayout.setAutoLoadMore(true);
    ...
    void refreshCard() {
        ...
        foods.add(new Food("Enjoying a Tasty Burger", "BY VIKTOR HANACEK", R.drawable.food2, R.drawable.avatar2));
